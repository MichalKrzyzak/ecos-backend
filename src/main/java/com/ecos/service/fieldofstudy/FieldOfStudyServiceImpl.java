...
public class FieldOfStudyServiceImpl implements FieldOfStudyService<FieldOfStudyDto, FieldOfStudyEntity> {
    ...
    public FieldOfStudyDto create(@RequestBody FieldOfStudyDto fieldOfStudyDto) {
        ...
        return convertToDto(fieldOfStudyRepository.save(new FieldOfStudyEntity(fieldOfStudy.getFieldOfStudy(), fieldOfStudy.getTeachers(), fieldOfStudy.getStudents(), fieldOfStudy.getAssignments())));
    }
